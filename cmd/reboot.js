...
message.channel.sendMessage(' ```Botun yeniden başlatılmasına onay veriyorsanız 30 saniye içinde evet yaz Mert abi.``` ')
.then(() => {
...
exports.help = {
  name: 'reboot',
  description: 'Bu komutu sadece botun kurucusu yazabilir.',
  usage: 'reboot'
};
